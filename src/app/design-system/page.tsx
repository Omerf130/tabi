...
export const metadata: Metadata = {
  ...
  description: "תצוגה פנימית של מערכת העיצוב.",
};
  ...
  return (
    <DesignSystemPreview>
      <main className={styles.main}>
        <p className={styles.kicker}>Tabi · Design System</p>
        <p className={styles.lede}>תצוגה פנימית של מערכת העיצוב.</p>
        ...
        <section className={styles.section} aria-labelledby="type-heading">
          ...
          <p className={styles.numeric}>08:42 · €128</p>
          <p className={styles.mixed} lang="en" dir="auto">
            Rome · Roma
          </p>
        </section>
        ...
        <section className={styles.section} aria-labelledby="fields-heading">
          ...
          <div className={styles.fieldStack}>
            <Field label="תחנה" htmlFor="station" hint="אפשר גם באנגלית">
              <Input
                id="station"
                name="station"
                placeholder="Termini"
            ...
            <Field label="סוג כרטיס" htmlFor="pass">
              <Select id="pass" name="pass" defaultValue="train">
                <option value="train">Train pass</option>
