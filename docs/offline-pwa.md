...
**Offline core** (cache last known trip payload): itinerary, activities, accommodation, addresses, passes, dictionary, emergency, packing, reminders, last known weather, last known currency rates.
